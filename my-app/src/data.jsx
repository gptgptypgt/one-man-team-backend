...
function MainboardFilter() {
  return (
    <>
      <h4>옵션 선택</h4>
      <div className="filter-group">
        <h4>제조사 <span className="muted">32개</span></h4>
        <div className="grid">
          <label><input type="checkbox" /> MSI</label>
          <label><input type="checkbox" /> ASUS</label>
          <label><input type="checkbox" /> GIGABYTE</label>
      ...
      <div className="filter-group">
        <h4>CPU 소켓 <span className="muted">26개</span></h4>
        <div className="grid">
      ...
      <div className="filter-group">
        <h4>세부 칩셋 <span className="muted">89개</span></h4>
        <div className="grid">
      ...
      <div className="filter-group">
        <h4>메모리 종류 <span className="muted">8개</span></h4>
        <div className="grid">
      ...
      <div className="filter-group">
        <h4>폼팩터 <span className="muted">8개</span></h4>
        <div className="grid">
...
function PowerFilter() {
  return (
    <>
      <h4>옵션 선택</h4>
      <div className="filter-group">
        <h4>제조사 <span className="muted">138개</span></h4>
        <div className="grid">
      ...
      <div className="filter-group">
        <h4>80PLUS인증 <span className="muted">67개</span></h4>
        <div className="grid">
      ...
      <div className="filter-group">
        <h4>ETA인증 <span className="muted">8개</span></h4>
        <div className="grid">
      ...
      <div className="filter-group">
        <h4>LAMBDA인증 <span className="muted">7개</span></h4>
        <div className="grid">
